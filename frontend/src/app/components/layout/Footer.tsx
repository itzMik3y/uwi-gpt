...
export function Footer() {
  return (
    <footer className="border-t bg-gray-900 p-6 text-gray-300">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 md:grid-cols-3">
        ...
        <div>
          ...
          <p className="mb-2 text-sm">support@uwi-gpt.edu</p>
          <p className="text-sm">1-888-UWI-GPT1</p>
          
          <div className="mt-4 flex gap-4">
            <Link href="#" aria-label="Twitter">
              <svg className="h-5 w-5 text-gray-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
