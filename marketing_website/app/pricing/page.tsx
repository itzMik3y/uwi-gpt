...
const PricingCard = ({
  ...
  exclusive,
    ...
    const cardClass = `w-72 flex flex-col justify-between py-1 mx-auto sm:mx-0 border ${popular ? "border-rose-400" : "border-zinc-700"} ${exclusive ? "animate-background-shine bg-white dark:bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] transition-colors" : ""}`

  const badgeClass = `px-2.5 rounded-xl h-fit text-sm py-1 text-black dark:text-white ${
    popular
...
export default function page() {
  ...
  return (
    <div className="py-8">
      <PricingHeader title="UWI-GPT Pricing" subtitle="Flexible plans for every student and institution" />
